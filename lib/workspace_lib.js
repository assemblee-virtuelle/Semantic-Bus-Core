...
var historiqueModel = require("../models/historique_model");
...
module.exports = {
  ...
  createHistorique: _createHistorique
};
...
function _createHistorique(historique) {
  //console.log("historique", historique.componentName)
  var historiqueModelObject = new historiqueModel({
    workspaceId: historique.workspaceId,
    workflowId: historique.workflowId,
    recordCount: historique.recordCount,
    moCount: historique.moCount,
    workflowComponentId: historique.workflowComponentId,
    userId: historique.userId,
    recordPrice: historique.recordPrice,
    totalPrice: historique.totalPrice,
    roundDate: historique.roundDate,
    workspaceName: historique.workspaceName,
